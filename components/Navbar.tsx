...
import { Terminal, User, Trophy, LayoutDashboard, Target, Users, Settings, Crown, LogOut, Home, Info, Phone, Shield } from "lucide-react";
 ...
 async function verify() {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full border-b border-border/50 bg-background/80 backdrop-blur-md">
     ...
     {(authenticated ? links : unauthlinks).map((link) => {
  const isActive =
  ...
  return (
    <Link
      ...
      className={`flex items-center gap-2 text-sm font-medium transition-colors hover:text-primary ${
        isActive
          ? "text-primary border-b-2 border-primary py-5 -mb-[2px]"
        ...
        <div className="flex items-center gap-4">
          {authenticated ? (
            ...
            <Link href="/get-started">
              <Button variant="default" className="font-mono font-semibold" data-testid="button-get-started">
