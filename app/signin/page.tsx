    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-sm space-y-8">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-bold font-mono tracking-tight">Welcome back</h1>
          <p className="text-muted-foreground text-sm">Sign in to continue competing</p>
        </div>
        ...
        <Card className="bg-card/50 border-border/50 shadow-xl">
          <CardContent className="pt-6 pb-6 space-y-4">
            <Button
              ...
              className="w-full h-11 font-mono font-semibold bg-white hover:bg-gray-50 text-gray-900 border border-gray-200 shadow-sm gap-3"
              variant="outline"
              asChild
            >
              <Link href="/dashboard">
            ...
            <Button
              ...
              variant="outline"
              className="w-full h-11 font-mono border-border/50 bg-background/50"
              asChild
            >
